...
/*
	Draws the menu background and the loading screen text.
*/
		...
		int percent, float *indef_pos)
{
	...
	driver->setFog(RenderingEngine::m_menu_sky_color);
	driver->beginScene(true, true, RenderingEngine::m_menu_sky_color);
